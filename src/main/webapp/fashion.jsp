    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="product-image">
                <img src="./assets/images/backPrint.jpg" alt="Product Image" class="img-fluid">
            </div>
        </div>
        <!-- Product Details -->
        <div class="col-md-6">
            <h2 class="product-title">Mens Backprint Shirt</h2>
...
<div class="container product-container">
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="product-image">
                <img src="./assets/images/croptop.jpg" alt="Product Image" class="img-fluid">
            </div>
        </div>
        <!-- Product Details -->
        <div class="col-md-6">
            <h2 class="product-title">Womens Croptop</h2>
